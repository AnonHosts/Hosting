...
const ADDRESS='CHANGE-THIS.ONION'; // our own address
const CANONICAL_URL='https://CHANGE-THIS-DOMAIN.COM'; // our preferred domain for search engines
const SERVERS=[ //servers and ports we are running on
'CHANGE-THIS.ONION'=>['sftp'=>22, 'pop3'=>'110', 'imap'=>'143', 'smtp'=>'25'],
'CHANGE-THIS-DOMAIN.COM'=>['sftp'=>22, 'pop3'=>'995', 'imap'=>'993', 'smtp'=>'465']
];
...
const COINPAYMENTS_FAKE_BUYER_EMAIL = 'contactus@anonhosts.com'; //fixed email used for the required buyer email field
const SITE_NAME = "AnonHost's Hosting"; //globally changes the sites title
